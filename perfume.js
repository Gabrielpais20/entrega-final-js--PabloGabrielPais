document.addEventListener('DOMContentLoaded', () => {
    ...
    let productsList2 = [
        { id: 1, name: 'armani', price: 195000, image: 'armani(comp).jpg' },
        { id: 2, name: 'bleu chanel', price: 175000, image: 'bleu-chanel(comp).jpg' },
        { id: 3, name: 'sauvage', price: 116400, image: 'sauvage(comp).jpg' },
        { id: 4, name: 'egeo', price: 190000, image: 'egeo(comp).jpg' },
        { id: 5, name: 'john varvatos', price: 134000, image: 'john-varvatos(comp).jpg' },
        { id: 6, name: 'valentino', price: 286000, image: 'valentino(comp).jpg' },
        { id: 7, name: 'miss dior', price: 104000, image: 'miss-dior(comp).jpg' },
        { id: 8, name: 'carolina herrera', price: 138000, image: 'carolina-herrera(comp).jpg' }
    ];

    let cart = JSON.parse(localStorage.getItem('cart')) || [];

    function renderProducts() {
        shopContainer.innerHTML = productsList2.map(product => `
            <div class="carts">
                <div>
    ...
    function addToCart(id) {
        const product = productsList2.find(item => item.id === id);
